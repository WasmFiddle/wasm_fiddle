...
function addFiddleContent(){
	...
	wasmIframe.innerText = `<iframe title="WASMFiddle-iFrame" id="wasm-embedded" width="100%" height="100%" src="http://http://34.106.253.95:8000/?fiddle_content=${btoa(fiddleContent).slice(0,-2)}"</iframe>`;
}
